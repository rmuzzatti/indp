...
summary_eEPSC_df <- make_summary_EPSC_data(
  data = raw_eEPSC_df %>% filter(letter %in% c("LS1", "LS2", "LS3", "LS4", "LS5", "LS6", "LS7", "LS8", "LS9", "LS10", "RM1", "RM2", "RM3", "RM4", "RM6", "RM7", "RM8", "RM9", "RMNC1", "RMNC1", "RMNC3", "RMNC4", "AV", "AW", "KMC8", "KMCL6", "KMCL9", "KML12", "KML5", "KML9", "TW15", "TW17", "TW18", "TW19", "TW2", "TW20", "TW21", "TW3", "TW37", "TW38", "TW4", "TW4", "TW8", "TW9", "TW24", "TW25", "TW26", "TW27")),
  current_type = "eEPSC",
...
```{r}
summary_eEPSC_df$summary_data %>% filter(letter %in% c("RM1", "RM2", "RM3", "RM4", "RM5", "RM6", "RM7", "RM8", "RM9")) %>% group_by(letter) %>% summarize(max=max(time))
...
t_test_female_noise_full <-perform_t_tests_for_summary_plot(
  data = summary_eEPSC_df$summary_data %>% filter(letter %in% c("RMNC1", "RMNC1", "RMNC3", "RMNC4")),
  test_category = 3,
  include_all_treatments = "no",
  list_of_treatments = c("Control"),
  current_type = "eEPSC",
