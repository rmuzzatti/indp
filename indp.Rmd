...
summary_eEPSC_df$summary_data %>% group_by(letter) %>% summarize(max=max(time))
```
...
#  significance_display_method = "p-values",
  geom_signif_text_size = 8,
  t_test_df = t_test_female_cold_full, # need male t-test too
  large_axis_text = "no",
  legend_position = "inside",
  shade_intervals = "no",
  treatment_colour_theme = my_theme_colours,
...
#  significance_display_method = "p-values",
  geom_signif_text_size = 8,
  t_test_df = t_test_female_noise_full, # need male t-test too
  large_axis_text = "no",
  legend_position = "inside",
  shade_intervals = "no",
  treatment_colour_theme = my_theme_colours,
