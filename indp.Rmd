...
female_PPR_df %>%
  filter(sex == "Female") %>%
  filter(letter %in% c("AA","AC", "AD", "AE", "AF", "AG", "AH", "AI", "AJ", "AK", "AL", "AM", "AN", "AO", "AP", "AQ", "AR", "AS", "AT", "AU", "AX", "AY", "CF", "CG", "CH", "LS1", "LS2", "LS3", "LS4", "LS5", "LS6", "LS7", "LS8", "LS9", "LS10", "RM1", "RM2", "RM3", "RM4", "RM5", "RM6", "RM7", "RM8", "RM9", "RM100", "RM101", "RM102", "RM103", "RM104")) %>%
  filter(treatment == "Control") %>%
  filter(category %in% c(1,2)) %>%
