...
ggsave(LS10_plot, path = here("Figures"), file = "LS10_plot.png", width = 7, height = 5, units = "in", dpi = 300)
```
...
# x-axis subtitles  
  annotate("text", x = 1, y = -0.2, label = "n = 36", size = 3, hjust = 0.5) + 
  annotate("text", x = 2, y = -0.2, label = "n = 14", size = 3, hjust = 0.5) + 
