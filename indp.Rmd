...
# t-test
  stat_compare_means(
    ...
    label.y = c(1.9, 2.1), # how do I make it not cut off
    size = 5
  ) +
...
# colours
  scale_fill_manual(values = c("1" = "#f19cac", "2" = "#6497b1", "3" = "#ecc479")) +
  scale_color_manual(values = c("1" = "#eb647e", "2" = "#005b96", "3" = "#f5e0b3")) +
